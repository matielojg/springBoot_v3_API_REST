...
class MedicoControllerTest {
	...
	void cadastrar_cenario2() throws Exception {
		...
		var dadosCadastro = new DadosCadastroMedico("Medico", "medico@voll.med", "61999999999", "123456",
	...
	private DadosEndereco dadosEndereco() {
		return new DadosEndereco("rua xpto", "bairro", "123456", "Brasilia", "DF", null, null);
	}
}